<div class="container">
    ...
    <div class="row g-4 justify-content-center">
        ...
        <div class="col-md-4 col-sm-6">
            ...
            <div class="card h-100 p-4 text-center menu-card" data-bs-toggle="modal" data-bs-target="#modalWaarmeking"
                data-bs-focus="false" style="cursor: pointer;">
                        ...
                        <div class="row g-3 justify-content-center">
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('waarmeking.surat-kuasa.index') }}" wire:navigate
                                    class="text-decoration-none text-dark">
                                    <div class="card p-4 h-100 menu-card border border-light-subtle">
                                        <div class="text-warning mb-2"><i class="bi bi-file-earmark-person fs-3"></i>
                                        </div>

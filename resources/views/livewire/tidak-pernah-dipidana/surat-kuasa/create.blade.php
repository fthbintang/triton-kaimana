<div class="card shadow-sm border-0 rounded-3">
    ...
    <div class="card-header bg-court text-white p-4 text-center rounded-top-3 position-relative">
        ...
        <h5 class="fw-bold m-0 text-uppercase" style="letter-spacing: 1px;">
            Formulir Surat Kuasa Tidak Pernah Dipidana
        </h5>
        <p class="text-white-50 small m-0 mt-1">
            Isilah data di bawah ini secara lengkap dan benar sesuai dengan dokumen asli (KTP) pemohon
        </p>
    </div>
    ...
    <div class="card-body p-4 p-md-5">
        ...
        <form wire:submit.prevent="save">
            ...
            <!-- BAGIAN II: PEMBERI KUASA -->
            <div class="mb-5">
                <div class="d-flex justify-content-between align-items-center border-bottom pb-2 mb-3">
                    <h5 class="text-court fw-bold m-0">
                        <span class="badge badge-court me-2">II</span> Pihak I: Pemberi Kuasa
                    </h5>
                ...
                <div class="alert alert-info border-0 bg-info bg-opacity-10 text-dark small rounded-3 mb-3 p-3">
                    ...
                    <p class="m-0 text-muted" style="font-size: 0.8rem;">
                        Masukkan data pemohon asli yang membutuhkan Surat Keterangan Tidak Pernah Dipidana. Pastikan
                        nama, NIK, dan alamat yang diinput telah sesuai dengan dokumen identitas resmi (KTP) yang
                        berlaku.
                    </p>
                </div>
                    ...
                    <div class="card bg-light border-0 mb-3 shadow-sm rounded-3" wire:key="pemberi-{{ $index }}">
                        <div class="card-body p-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    <label class="form-label text-muted small mb-1 fw-semibold">Id KTP (NIK 16
                                        Digit)</label>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" wire:model="pemberi_kuasa.{{ $index }}.pekerjaan"
                                        class="form-control form-control-sm" placeholder="Contoh: Karyawan Swasta, PNS">
                                </div>
                                <div class="col-md-12">
            ...
            <div class="mb-5">
                ...
                <p class="text-muted small mb-3 fst-italic">
                    * Penerima Kuasa adalah pihak keluarga atau orang kepercayaan yang ditunjuk untuk mengurus
                    permohonan berkas ke Pengadilan Negeri Kaimana.
                </p>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" wire:model="penerima_kuasa.{{ $index }}.pekerjaan"
                                        class="form-control form-control-sm"
                                        placeholder="Contoh: Wiraswasta, Ibu Rumah Tangga">
                                </div>
                                <div class="col-md-12">
                                    <label class="form-label text-muted small mb-1 fw-semibold">Alamat Lengkap (Sesuai
                                        KTP)</label>

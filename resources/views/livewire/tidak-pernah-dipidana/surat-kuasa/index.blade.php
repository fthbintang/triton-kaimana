<div>
    @if ($isCreating)
        @include('livewire.tidak-pernah-dipidana.surat-kuasa.create')
    @else
            ...
            <div class="card border-0 shadow-sm rounded-3">
                ...
                <div
                    ...
                    <div class="d-flex align-items-start gap-3">
                        ...
                        <div>
                            <h4 class="card-title mb-1 fw-bold text-dark">
                                <i class="bi bi-file-earmark-text-fill me-2 text-primary"></i>Surat Kuasa Tidak Pernah
                                Dipidana
                            </h4>
                            <p class="text-muted small mb-0">Manajemen berkas kuasa permohonan keterangan tidak pernah
                                dipidana di lingkup Pengadilan Negeri Kaimana</p>
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-column gap-2 w-100 ms-md-auto" style="max-width: 300px;">
                        ...
                        <a href="{{ route('tidak-dipidana.surat-kuasa-tidak-dihukum.create') }}" wire:navigate
                                    ...
                                    <tr>
                                            ...
                                            <div class="fw-semibold text-dark">
                                                @if ($item->penerimaKuasa->count() > 1)
                                                    ...
                                                    <span class="badge bg-secondary" style="font-size: 10px;">
                                                        +{{ $item->penerimaKuasa->count() - 1 }} Orang
                                                    </span>
                                                @else
                                                    {{ $item->penerimaKuasa->first()?->nama ?? '-' }}
                                                @endif
                                        ...
                                        <td>
                                            <span class="text-dark">
                                                <i
                                                    class="bi bi-whatsapp text-success me-1"></i>{{ $item->no_hp_pemohon }}
                                            </span>
                                        </td>

                                        <td class="pe-4 text-center">
                                            <div class="d-inline-flex gap-1 align-items-center">
                                                <a href="{{ route('tidak-dipidana.surat-kuasa-tidak-dihukum.edit', ['id' => $item->id]) }}"
                                                    wire:navigate
                                                        ...
                                                        <div class="modal-content border-0 shadow rounded-3 text-start">
                                                            ...
                                                            <div class="modal-body text-center p-4">
                                                                ...
                                                                <div class="d-grid gap-2">
                                                                    <a href="{{ route('cetak.surat-kuasa-tidak-dihukum.pdf', ['id' => $item->id]) }}"
                                                                        target="_blank"
                                                                    ...
                                                                    <a href="{{ route('cetak.surat-kuasa-tidak-dihukum.word', ['id' => $item->id]) }}"

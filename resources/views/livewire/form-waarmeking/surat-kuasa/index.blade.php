<div>
    @if ($isCreating)
        @include('livewire.form-waarmeking.surat-kuasa.create')
    @else
            ...
            <div class="card border-0 shadow-sm rounded-3">
                ...
                <div
                    ...
                    <div class="d-flex align-items-start gap-3">
                        ...
                        <div>
                            <h4 class="card-title mb-1 fw-bold text-dark">
                                <i class="bi bi-file-earmark-text-fill me-2 text-primary"></i>Surat Kuasa Waarmeking
                            </h4>
                            <p class="text-muted small mb-0">Manajemen delegasi berkas kuasa ahli waris di lingkup
                    ...
                    <div class="d-flex flex-column gap-2 w-100 ms-md-auto" style="max-width: 300px;">
                        ...
                        <a href="{{ route('waarmeking.surat-kuasa.create') }}" wire:navigate
                                    ...
                                    <tr>
                                        ...
                                        <td class="pe-4 text-center">
                                            <div class="d-inline-flex gap-1 align-items-center">
                                                <a href="{{ route('waarmeking.surat-kuasa.edit', ['id' => $item->id]) }}"
                                                    wire:navigate
                                                        ...
                                                        <div class="modal-content border-0 shadow rounded-3 text-start">
                                                            ...
                                                            <div class="modal-body text-center p-4">
                                                                ...
                                                                <div class="d-grid gap-2">
                                                                    <a href="{{ route('cetak.surat-kuasa.waarmeking.pdf', ['id' => $item->id]) }}"
                                                                        target="_blank"

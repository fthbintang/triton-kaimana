                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text"
                            ...
                            wire:model="hubungan_penerima_ke_pemberi" placeholder="Contoh: Anak Kandung, Suami, Istri">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text"
                            ...
                            wire:model="hubungan_pemberi_ke_penerima" placeholder="Contoh: Ibu Kandung, Ayah Kandung">
            ...
            <div class="row g-2 mt-4 pt-3 border-top">
                ...
                <div class="col-6 col-md-3">
                    <button type="submit" class="btn btn-court w-100 py-2 fw-bold rounded-3 shadow-sm">
                        <span wire:loading.remove>Kirim Form <i class="bi bi-send-fill ms-1 small"></i></span>

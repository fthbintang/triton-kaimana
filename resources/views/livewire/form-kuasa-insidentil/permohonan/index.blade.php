                                        ...
                                        <div class="p-2 bg-light rounded-2 border border-light-subtle"
                                            ...
                                            <ul class="list-unstyled mb-0">
                                                ...
                                                <li>
                                                    ...
                                                    <span
                                                        class="text-dark fw-medium">{{ Str::limit($item->data_spesifik['perkara']['jenis_perkara'] ?? '-', 40) }}</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
                                            ...
                                            <div class="modal fade" id="modalCetak{{ $item->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-sm">
                                                    <div class="modal-content border-0 shadow rounded-3">
                                                        ...
                                                        <div
                                                            class="modal-header bg-light border-top-0 justify-content-center py-2">
                                                            <button type="button"
